    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-5 justify-center items-center p-8">
        ...
        <div className="max-w-4xl text-md text-gray-700 dark:text-gray-300 text-center">
          Our esteemed panel of judges comprises industry leaders and experts who bring a wealth of knowledge and experience to the table. They will evaluate projects based on innovation, technical excellence, and real-world impact. Get ready to impress them with your creativity and skills!
        </div>
